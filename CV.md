...
Warsaw, Poland · pavlenkovictor92@gmail.com · +48 506 933 862
linkedin.com/in/victor-pavlenko · github.com/victorpavlenko · victorpavlenko.github.io

---

## Summary

Lead Software Engineer with 14 years architecting and shipping production systems across web, mobile, and backend. Specializes in distributed systems, microservices architecture, scalable platforms, and high-availability infrastructure. JavaScript-first engineer with hands-on work in TypeScript, Python, PHP, Go, and Rust. Delivered crypto wallets, AI dashboards, RAG systems, chatbots, payment platforms, ERPs, and e-commerce engines used by 350K+ merchants and 5M+ users across e-commerce, fintech, crypto/Web3, AI/LLM, and big data. Track record of leading cross-functional teams, mentoring engineers, owning architecture decisions, and driving code review culture in Agile/Scrum environments. Leverages Claude Code as a daily IDE with multi-agent workflows, MCP tools, and custom subagents to ship 3–5x faster than traditional teams.

---

## Skills

**Languages:** JavaScript (primary), TypeScript (primary), Python, PHP, Go, Rust, SQL, HTML, CSS, Bash

**AI / LLM:** Claude Code, Anthropic SDK, OpenAI API, MCP (Model Context Protocol), Multi-Agent Systems, Subagents & Tool Use, RAG Pipelines, Vector Databases, Chatbots, Streaming LLM UIs, Prompt Engineering, AI Agents

**Frontend:** React, Next.js, React Native, TypeScript, Angular, Vue.js, jQuery, Redux, TailwindCSS, D3, Recharts, Responsive Design

**Backend:** Node.js, NestJS, Express, GraphQL, REST API, SSE, WebSocket, Microservices

**Architecture & Practices:** System Design, Distributed Systems, Microservices Architecture, Event-Driven Architecture, Scalability, High Availability, Test-Driven Development (TDD), Unit Testing, Code Review, Technical Leadership, Mentoring, Architecture Decisions, Cross-Functional Collaboration, Agile, Scrum, SDLC, OOP

**Industries:** E-commerce, Fintech, Crypto / Web3, AI / LLM, Big Data, SaaS, ERP, Marketplace

**Web3 & Payments:** Ethers.js, Web3.js, Multi-chain (EVM, Solana, Bitcoin, BNB, Tron), MetaMask, WalletConnect, Phantom, Stripe API, Payment Gateways, Crypto Checkout, Subscription Billing, WebCrypto API

**Infrastructure & Cloud:** PostgreSQL, MongoDB, Redis, Firebase, Docker, Kubernetes, AWS, Google Cloud, Vercel, GitHub Actions, CI/CD, Git, Linux

**Product & Design:** Mobile-first UX, Responsive Design, Design Systems, Figma, Accessibility

---

## Experience

### Lead Software Engineer · PremAI
*Jan 2025 – Present · Remote · premai.io*
...
- AI-augmented delivery: built dashboard, mobile app, and encryption layer with Claude Code multi-agent workflows — feature parity in ⅓ the headcount.

*Stack:* React, React Native, TypeScript, Next.js, Node.js, TailwindCSS, Recharts, D3.js, WebCrypto API, SSE, Claude Code

---

### Lead Software Engineer · BitGPT
*Jan 2025 – Present · Remote · bitgpt.xyz*
...
### Lead Software Engineer · Sellix
*Jan 2020 – Jan 2025 · Remote · sellix.io*
...
### Lead Software Engineer · Startwire
*Jan 2017 – Jan 2019 · Remote · startwire.com*

- 5M+ users — solo-led platform migration Angular 1.x → React, zero downtime, no feature regression.
...
### Software Engineer · Tech Lead · Carjojo
*Jan 2017 – Jan 2018 · Remote · carjojo.com*

- Led Angular → React migration — performance, maintainability, team velocity gains.
...
### Software Engineer · Bizly
*2017 · Remote · bizly.com*
...
### Software Engineer · Slooh
*2017 · Remote · slooh.com*
...
### Software Engineer · Founding · Lifograph
*Jan 2015 – Jan 2017 · Remote · lifograph.com*
...
### Software Engineer · Yuterra & Colors.life
*Jan 2014 – Jan 2015 · Remote*
...
### Software Engineer · Tinko
*Jan 2013 – Jan 2014 · On-site · tinko.ru*
...
English (professional) · Russian (native) · Polish (working)
